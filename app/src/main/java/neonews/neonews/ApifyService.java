...
public class ApifyService {
    public static List<Subject> getCnewsMatin() throws IOException, JSONException {
        ...
        for (int i = 0; i < Jarray.length(); i++) {
            ...
            listSubject.add(new Subject(object.getString("image"), object.getString("title"), "", null));
        }
        return listSubject;
    }
}
